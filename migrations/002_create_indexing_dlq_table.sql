...
-- =====================================================
CREATE TABLE IF NOT EXISTS knowledge.indexing_dlq (
    -- Identity
...
COMMENT ON COLUMN knowledge.indexing_dlq.resolved IS 
