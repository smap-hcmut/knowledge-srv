...
# SMAP Knowledge Consumer - Build and Push Script
...
build_and_push() {
    ...
    echo "  - $latest_name"
    echo ""
    info "To deploy, update the image in manifests/consumer-deployment.yaml:"
...
show_help() {
    cat << EOF
${GREEN}SMAP Knowledge Consumer - Build and Push Script${NC}
...
Build Process:
    1. Builder stage   - Download deps, compile Go binary
