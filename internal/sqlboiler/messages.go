...
type Message struct {
	...
	Citations null.JSON `boil:"citations" json:"citations,omitempty" toml:"citations" yaml:"citations,omitempty"`
	// JSONB object with search processing stats: total_docs_searched, docs_used, processing_time_ms, model_used
	SearchMetadata null.JSON `boil:"search_metadata" json:"search_metadata,omitempty" toml:"search_metadata" yaml:"search_metadata,omitempty"`
	// JSONB array of follow-up question suggestions (assistant messages only)
	Suggestions null.JSON `boil:"suggestions" json:"suggestions,omitempty" toml:"suggestions" yaml:"suggestions,omitempty"`
	// JSONB object with the search filters that were applied (user messages only)
	FiltersUsed null.JSON `boil:"filters_used" json:"filters_used,omitempty" toml:"filters_used" yaml:"filters_used,omitempty"`
...
var MessageTableColumns = struct {
	...
	SearchMetadata: "messages.search_metadata",
	Suggestions:    "messages.suggestions",
	FiltersUsed:    "messages.filters_used",
...
var MessageWhere = struct {
	...
	Citations      whereHelpernull_JSON
	SearchMetadata whereHelpernull_JSON
	Suggestions    whereHelpernull_JSON
	FiltersUsed    whereHelpernull_JSON
	CreatedAt      whereHelpernull_Time
}{
	ID:             whereHelperstring{field: "\"schema_knowledge\".\"messages\".\"id\""},
	ConversationID: whereHelperstring{field: "\"schema_knowledge\".\"messages\".\"conversation_id\""},
	Role:           whereHelperstring{field: "\"schema_knowledge\".\"messages\".\"role\""},
	Content:        whereHelperstring{field: "\"schema_knowledge\".\"messages\".\"content\""},
	Citations:      whereHelpernull_JSON{field: "\"schema_knowledge\".\"messages\".\"citations\""},
	SearchMetadata: whereHelpernull_JSON{field: "\"schema_knowledge\".\"messages\".\"search_metadata\""},
	Suggestions:    whereHelpernull_JSON{field: "\"schema_knowledge\".\"messages\".\"suggestions\""},
	FiltersUsed:    whereHelpernull_JSON{field: "\"schema_knowledge\".\"messages\".\"filters_used\""},
	CreatedAt:      whereHelpernull_Time{field: "\"schema_knowledge\".\"messages\".\"created_at\""},
}
...
var (
	messageAllColumns            = []string{"id", "conversation_id", "role", "content", "citations", "search_metadata", "suggestions", "filters_used", "created_at"}
	messageColumnsWithoutDefault = []string{"conversation_id", "role", "content"}
	messageColumnsWithDefault    = []string{"id", "citations", "search_metadata", "suggestions", "filters_used", "created_at"}
...
func (q messageQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Message, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler: failed to execute a one query for messages")
	}
...
func (q messageQuery) All(ctx context.Context, exec boil.ContextExecutor) (MessageSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlboiler: failed to assign all query results to Message slice")
	}
...
func (q messageQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to count messages rows")
	}
...
func (q messageQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler: failed to check if messages exists")
	}
...
func (messageL) LoadConversation(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMessage any, mods queries.Applicator) error {
	var slice []*Message
	var object *Message
	...
	query := NewQuery(
		qm.From(`schema_knowledge.conversations`),
		qm.WhereIn(`schema_knowledge.conversations.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func Messages(mods ...qm.QueryMod) messageQuery {
	mods = append(mods, qm.From("\"schema_knowledge\".\"messages\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"schema_knowledge\".\"messages\".*"})
	}
...
func FindMessage(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Message, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"schema_knowledge\".\"messages\" where \"id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler: unable to select from messages")
	}
...
func (o *Message) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler: no messages provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"schema_knowledge\".\"messages\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"schema_knowledge\".\"messages\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to insert into messages")
	}
...
func (o *Message) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboiler: unable to update messages, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"schema_knowledge\".\"messages\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update messages row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by update for messages")
	}
...
func (q messageQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update all for messages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to retrieve rows affected for messages")
	}
...
func (o MessageSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"schema_knowledge\".\"messages\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to update all in message slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to retrieve rows affected all in update all message")
	}
	return rowsAff, nil
}
...
func (o *Message) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("sqlboiler: no messages provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("sqlboiler: unable to upsert messages, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(messagePrimaryKeyColumns) == 0 {
				return errors.New("sqlboiler: unable to upsert messages, could not build conflict column list")
			}

			conflict = make([]string, len(messagePrimaryKeyColumns))
			copy(conflict, messagePrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"schema_knowledge\".\"messages\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to upsert messages")
	}
...
func (o *Message) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlboiler: no Message provided for delete")
	}
	...
	sql := "DELETE FROM \"schema_knowledge\".\"messages\" WHERE \"id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete from messages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by delete for messages")
	}
...
func (q messageQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlboiler: no messageQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete all from messages")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: failed to get rows affected by deleteall for messages")
	}
...
func (o MessageSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"schema_knowledge\".\"messages\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler: unable to delete all from message slice")
	}
...
func (o *MessageSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"schema_knowledge\".\"messages\".* FROM \"schema_knowledge\".\"messages\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, messagePrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler: unable to reload all in MessageSlice")
	}
...
func MessageExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"schema_knowledge\".\"messages\" where \"id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler: unable to check if messages exists")
	}
