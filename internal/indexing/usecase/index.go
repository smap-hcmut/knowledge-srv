...
func (uc *implUseCase) prepareQdrantPayload(record indexing.AnalyticsPost) map[string]interface{} {
	payload := analyticsPayload{
		...
		Metadata: analyticsMetadataPayload{
			...
			AuthorUsername:    record.UAPMetadata.AuthorUsername,
			AuthorAvatar:      record.UAPMetadata.AuthorAvatar,
			AuthorFollowers:   record.UAPMetadata.AuthorFollowers,
			AuthorIsVerified:  record.UAPMetadata.AuthorIsVerified,
			...
			URL:           record.UAPMetadata.URL,
			PostURL:       record.UAPMetadata.PostURL,
			OriginalURL:   record.UAPMetadata.OriginalURL,
			Permalink:     record.UAPMetadata.Permalink,
			SourceURL:     record.UAPMetadata.SourceURL,
			WebURL:        record.UAPMetadata.WebURL,
			CommentURL:    record.UAPMetadata.CommentURL,
			ParentPostURL: record.UAPMetadata.ParentPostURL,
			VideoURL:      record.UAPMetadata.VideoURL,
			ContentType:   record.UAPMetadata.ContentType,
			RootID:        record.UAPMetadata.RootID,
			ParentID:      record.UAPMetadata.ParentID,
			Hashtags:      record.UAPMetadata.Hashtags,
			Location:      record.UAPMetadata.Location,
			PlatformMeta:  record.UAPMetadata.PlatformMeta,
			Hierarchy:     record.UAPMetadata.Hierarchy,
		},
	}
